        ...
        <div className="hero2ContainerDouble">
          ...
          <div className="hero2ContainerRightSide">
            ...
            <div className="hero2ContainerRightSideText2">
              Poprzez wieloletnią obecność na rynku posiadamy dostęp do
              najpiękniejszych choinek. Mamy sprawdzonych dostawców, dla których
              uprawa drzew dekoracyjnych to życiowa pasja. Dzięki temu możemy
              zaoferować najlepsze ceny i gwarancję satysfakcji dla Twoich
              przyszłych klientów. Zapraszamy do zapytań o choinki w ilościach
              hurtowych.
            </div>
          </div>
        </div>
