...
const Product = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://127.0.0.1:5000/choinka/${id}`)
      .then((response) => {
    ...
    axios
      ...
      .then((response) =>
        setRelatedProducts(
          response.data.filter((p) => p.id !== parseInt(id)).slice(0, 5)
        )
      )
    ...
    <div className="product">
      ...
      <div className="productContainer">
        ...
        <div className="productDetails">
          ...
          <p>
            Dostępność: {product.ilosci[0] > 0 ? "Dostępne" : "Niedostępne"}
          </p>
          ...
          <select
            value={recyclingOption}
            onChange={(e) => setRecyclingOption(e.target.value)}
          >
          ...
          <div className="quantityContainer">
            <button
              ...
              className="quantityContainerBtn"
            >
              -
            </button>
            <input
      ...
      <div className="relatedProducts">
        ...
        <div className="relatedProductsContainer">
          {relatedProducts.map((relatedProduct) => (
            ...
            >
              <img
                src={relatedProduct.zdjecia?.[0]}
                alt={relatedProduct.nazwa}
